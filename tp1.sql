...
--32
SELECT I.Nom, I.NoCarte
FROM INSCRIT I, INSCRIT INSCRIT2, PARTICIPATION P, PARTICIPATION C
WHERE INSCRIT2.Nom = 'Bonnard' AND P.NoCarte = INSCRIT2.NoCarte
	  AND P.NomCours =  C.NomCours AND C.NoCarte = I.NoCarte AND I.Nom != 'Bonnard'


SELECT I.Nom, I.NoCarte
FROM INSCRIT I JOIN INSCRIT INSCRIT2 ON INSCRIT2.Nom = 'Bonnard'
			   JOIN PARTICIPATION P ON P.NoCarte = INSCRIT2.NoCarte
			   JOIN PARTICIPATION C ON P.NomCours =  C.NomCours
WHERE C.NoCarte = I.NoCarte AND I.Nom != 'Bonnard'
